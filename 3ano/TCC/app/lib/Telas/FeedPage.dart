...
class _FeedPageState extends State<FeedPage> {
  ...
  void initState() {
    ...
    feed.add(FeedImage(
        ...
        text: 'Chegada da Família Real no Brasil',
        url:
    ...
    feed.add(FeedImage(
        ...
        url: 'https://miro.medium.com/max/5196/1*jXpWPE67i7ujaE1v9-1XQQ.jpeg',
        date: ''));
    feed.add(FeedImage(
    ...
    feed.add(FeedImage(
        ...
        text: 'Movimentos Sociais Urbanos durante a Primeira República',
        url:
    ...
    feed.add(FeedImage(
        ...
        text: 'Movimentos Sociais Gerais durante a Primeira República',
        url:
